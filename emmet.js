...
emmet.exec(function(require, _) {
	...
	"html": {
      ...
      "ap:af" : "<apex:actionFunction name='' value='' oncomplete='' reRender= '' />",  
      "ap:ap" : "<apex:actionPoller action='' rerender='' interval=''/>",  
      "ap:ar" : "<apex:actionRegion>",  
      "ap:astat" : "<apex:actionStatus startText='(incrementing...)' stopText='(done)' id='' />",  
      "ap:asup" : "<apex:actionSupport event='onclick' action='{!}' rerender='' status=''/>",  
      "ap:aser" : "<apex:areaSeries axis='left' xField='name' yField='' tips='true'/>",  
      "ap:attr" : "<apex:attribute name='' description='' type='String' required='true'/>",  
      "ap:ax" : "<apex:axis type='Numeric' position='left' fields='' title='' grid='true'/>",  
      "ap:bar" : "<apex:barSeries title='' orientation='vertical' axis='right' xField='name' yField='data3'></apex:barSeries>",  
      "ap:can" : "<apex:canvasApp developerName='canvasAppName' namespacePrefix='fromDevOrgNamespacePrefix' containerId='{!$Component.myContainer}'/>",  
      "ap:chart" : "<apex:chart data=''>",  
      "ap:chlab" : "<apex:chartLabel />",  
      "ap:chtip" : "<apex:chartTips height='20' width='120'/>",  
      "ap:col" : "<apex:column>",  
      "ap:cmdbtn" : "<apex:commandButton>",  
      "ap:cmdlink" : "<apex:commandLink>",  
      "ap:cmp" : "<apex:component>",  
      "ap:cmpbod" : "<apex:componentBody>",  
      "ap:comp" : "<apex:composition>",  
      "ap:dtl" : "<apex:dataList>",  
      "ap:dtb" : "<apex:dataTable>",  
      "ap:def" : "<apex:define></apex:define>",  
      "ap:det" : "<apex:detail>",  
      "ap:dc" : "<apex:dynamicComponent>",  
      "ap:ep" : "<apex:emailPublisher>",  
      "ap:el" : "<apex:enhancedList>",  
      "ap:facet" : "<apex:facet>",  
      "ap:flash" : "<apex:flash>",  
      "ap:f" : "<apex:form>",  
      "ap:gs" : "<apex:gaugeSeries>",  
      "ap:iframe" : "<apex:iframe>",  
      "ap:img" : "<apex:image>",  
      "ap:inc" : "<apex:include>",  
      "ap:incs" : "<apex:includeScript value=''>",  
      "ap:ies" : "<apex:inlineEditSupport>",  
      "ap:ichk" : "<apex:inputCheckbox>",  
      "ap:inpf" : "<apex:inputField value='' />",  
      "ap:infile" : "<apex:inputFile>",  
      "ap:ihide" : "<apex:inputHidden>",  
      "ap:isec" : "<apex:inputSecret>",  
      "ap:it" : "<apex:inputText>",  
      "ap:ita" : "<apex:inputTextarea>",  
      "ap:ins" : "<apex:insert></apex:insert>",  
      "ap:leg" : "<apex:legend>",  
      "ap:ls" : "<apex:lineSeries>",  
      "ap:lv" : "<apex:listViews>",  
      "ap:lcp" : "<apex:logCallPublisher>",  
      "ap:msg" : "<apex:message>",  
      "ap:msgs" : "<apex:messages>",  
      "ap:of" : "<apex:outputField>",  
      "ap:ol" : "<apex:outputLabel>",  
      "ap:olink" : "<apex:outputLink>",  
      "ap:op" : "<apex:outputPanel>",  
      "ap:ot" : "<apex:outputText>",  
      "ap:pg" : "<apex:page>",  
      "ap:pb" : "<apex:pageBlock title='' >",  
      "ap:pbb" : "<apex:pageBlockButtons>",  
      "ap:pbs" : "<apex:pageBlockSection>",  
      "ap:pbsi" : "<apex:pageBlockSectionItem>",  
      "ap:pbt" : "<apex:pageBlockTable>",  
      "ap:pm" : "<apex:pageMessage>",  
      "ap:pms" : "<apex:pageMessages>",  
      "ap:pnb" : "<apex:panelBar>",  
      "ap:pnbi" : "<apex:panelBarItem>",  
      "ap:png" : "<apex:panelGrid>",  
      "ap:pngr" : "<apex:panelGroup>",  
      "ap:p" : "<apex:param>",  
      "ap:ps" : "<apex:pieSeries>",  
      "ap:rs" : "<apex:radarSeries>",  
      "ap:rl" : "<apex:relatedList>",  
      "ap:rep" : "<apex:repeat>",  
      "ap:ss" : "<apex:scatterSeries>",  
      "ap:sc" : "<apex:scontrol>",  
      "ap:sh" : "<apex:sectionHeader>",  
      "ap:schk" : "<apex:selectCheckboxes>",  
      "ap:sl" : "<apex:selectList>",  
      "ap:so" : "<apex:selectOption>",  
      "ap:sos" : "<apex:selectOptions>",  
      "ap:sr" : "<apex:selectRadio>",  
      "ap:stl" : "<apex:stylesheet></apex:stylesheet>",  
      "ap:t" : "<apex:tab>",  
      "ap:tp" : "<apex:tabPanel>",  
      "ap:tb" : "<apex:toolbar>",  
      "ap:tbg" : "<apex:toolbarGroup>",  
      "ap:var" : "<apex:variable>",  
      "ap:vot" : "<apex:vote>",  
      "ch:f" :"<chatter:feed>",  
      "ch:ff" :"<chatter:feedWithFollowers>",  
      "ch:fo" :"<chatter:follow>",  
      "ch:fos" :"<chatter:followers>",  
      "ch:nf" :"<chatter:newsfeed>",  
      "cha:all" :"<chatteranswers:allfeeds>",  
      "cha:cp" :"<chatteranswers:changepassword>",  
      "cha:fp" :"<chatteranswers:forgotpassword>",  
      "cha:fpc" :"<chatteranswers:forgotpasswordconfirm>",  
      "cha:h" :"<chatteranswers:help>",  
      "cha:l" :"<chatteranswers:login>",  
      "cha:r" :"<chatteranswers:registration>",  
      "cha:si" :"<chatteranswers:singleitemfeed>",  
      "fl:i" : "<flow:interview>",  
      "id:do" : "<ideas:detailOutputLink>",  
      "id:lo" : "<ideas:listOutputLink>",  
      "id:plo" : "<ideas:profileListOutputLink>",  
      "kl:act" : "<knowledge:articleCaseToolbar>",  
      "kl:al" : "<knowledge:articleList>",  
      "kl:art" : "<knowledge:articleRendererToolbar>",  
      "kl:atl" : "<knowledge:articleTypeList>",
      "kl:cl" : "<knowledge:categoryList>",
      "la:cc" : "<liveAgent:clientChat>",
      "la:ccm" : "<liveAgent:clientChatAlertMessage>",
      "la:cce" : "<liveAgent:clientChatEndButton>",
      "la:cci" : "<liveAgent:clientChatInput>",
      "la:ccl" : "<liveAgent:clientChatLog>",
      "la:ccm" : "<liveAgent:clientChatMessages>",
      "la:ccq" : "<liveAgent:clientChatQueuePosition>",
      "la:ccsav" : "<liveAgent:clientChatSaveButton>",
      "la:ccsen" : "<liveAgent:clientChatSendButton>",
      "la:ccsm" : "<liveAgent:clientChatStatusMessage>",
      "msg:a" : "<messaging:attachment>",
      "msg:eh" : "<messaging:emailHeader>",
      "msg:et" : "<messaging:emailTemplate>",
      "msg:heb" : "<messaging:htmlEmailBody>",
      "msg:p" : "<messaging:plainTextEmailBody>",
      "si:g" : "<site:googleAnalyticsTracking>",
      "si:p" : "<site:previewAsAdmin>",  
      "so:pv" : "<social:profileViewer>",  
      "su:ca " : "<support:caseArticles>",  
      "su:cf " : "<support:caseFeed>",
      "su:pp " : "<support:portalPublisher>"
		}
	},
